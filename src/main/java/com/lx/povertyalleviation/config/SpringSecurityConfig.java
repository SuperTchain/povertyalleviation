...
//                添加过滤界面
                .antMatchers("/static/**","/login.html","/index.html","/forget.html","/regist","/toregist","/search","/webjars/**","/getCode","/login","/","/index",
                        ...
                        "/product/toViewProduct","/product/findProductByCondition","/product/findProductById","/policy/toViewPolicy","/policy/findPolicyById","/policy/findPolicyByPolicyKind").permitAll()
//                拦截所有页面
