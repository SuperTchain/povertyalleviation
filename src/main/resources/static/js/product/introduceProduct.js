...
//     })
    ...
    function renderProductHtml(data){
        ...
        if(data.length > 0){
            $.each(data, function(v, o){
                str += "<div style='text-align:center;font-size: 22px'><span>"+o.productName+"</span></div>";
                str += "<div style='text-align:center;font-size: 22px'><span style='color:#CDC9C9;'>"+o.productComposition+"</span></div>";
    ...
    function renderProduct(page, limit){
        $.ajax({
            async: false,
            url: '/product/findCompositionList',
